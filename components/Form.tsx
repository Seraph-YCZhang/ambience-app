		...
		<div className='w-full' id='form'>
				...
				<div className='w-full h-full flex flex-col'>
					<div className='relative p-[30px] shrink-0'>
						...
						<div className='text-[#252525] text-[20px] font-semibold mb-[18px]'>
							We&lsquo;ve created the video unit for you! You can
					...
					<div className='relative flex-1' id='generated-image-ctn'>
						<Image
							alt='video'
			...
			<div className='bg-[#EEE] w-full justify-center pt-[50px] h-[804px] flex flex-col'>
				...
				<div className='flex mt-auto'>
					...
					<div
						className={classNames(
							'ml-auto  mr-[52px] w-[516px] h-16 bg-[#484BC9] rounded-[67.5px] cursor-pointer flex items-center justify-center',
							{
