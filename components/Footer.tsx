...
export default function Footer() {
	return (
		<div className='min-h-[220px] w-full bg-[#393939] py-[40px] text-[#bbbfc4] flex flex-col items-center'>
			<div className=' ml-auto mr-[50px]'>
				<div className='flex border-b-[1px] border-solid border-[#fff] pb-4 max-w-[min(100vw,1440px)]'>
					<div>
						<Image
							src='/logo.svg'
							alt='Cozyverse Logo'
						...
						<div className='ml-2 mt-4 text-[14px] max-w-[400px]'>
							Cozyverse is a platform created by XYG studio, at
							here, you can create, enjoy and share your cozy
							world!
						</div>
					</div>
